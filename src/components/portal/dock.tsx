...
export type DockIcon = "review" | "upnext" | "finder" | "completed" | "viewer" | "note";
...
/**
 * The Project Viewer badge, built like public/icons/folder.svg: dark offset
 * circle, green disc with the dark 3.4px stroke, and a white stack of two
 * cards as the pictogram.
 */
function ViewerBadge({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 70 70" fill="none" aria-hidden="true" focusable="false" className="portal-dock-icon">
      ...
      <rect x="23" y="18.5" width="27" height="20" rx="3" fill="#151919" />
      <rect x="17.5" y="26" width="27" height="20" rx="3" fill="white" stroke="#151919" strokeWidth="3.40657" strokeLinejoin="round" />
      <path d="M17.5 32.5h27" stroke="#151919" strokeWidth="3.40657" />
    </svg>
  );
}
...
const ICON_SRC: Record<Exclude<DockIcon, "viewer">, string> = {
  review: "/icons/bell-notification.svg",
  upnext: "/icons/calendar.svg",
  finder: "/icons/folder.svg",
  completed: "/icons/book.svg",
  note: "/icons/pencil.svg",
};

/**
 * The floating capsule dock (the MOGRT Library's SlideDock look): one item per
 * application window plus the Completed projects shortcut. A 4px dot under
 * each icon: solid green open, hollow minimized, none closed.
 */
